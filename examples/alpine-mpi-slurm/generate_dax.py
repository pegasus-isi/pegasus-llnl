...
actions_json.addPFN(PFN("file:///g/g91/pandey1/alpine/alpine/build-debug/examples/proxies/lulesh2.0.3/alpine_actions.json","catalyst"))

options_json = File("alpine_options.json")
options_json.addPFN(PFN("file:///g/g91/pandey1/alpine/alpine/build-debug/examples/proxies/lulesh2.0.3/alpine_options.json","catalyst"))

lulesh_par = File("lulesh_par")
lulesh_par.addPFN(PFN("file:///g/g91/pandey1/alpine/alpine/build-debug/examples/proxies/lulesh2.0.3/lulesh_par","catalyst"))
